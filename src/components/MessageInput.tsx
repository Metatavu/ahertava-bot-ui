              ...
              <Grid.Row verticalAlign="middle" columns="equal">
                <Grid.Column style={{paddingRight: "15px"}}>
                  <Input
                    ...
                    fluid  />
                  <Button icon="paper plane" className="message-send" disabled={this.props.waitingForBot} onClick={this.onSendButtonClick}></Button>
                </Grid.Column>
              </Grid.Row>
      ...
      <div className="global-quick-responses">
        { this.props.globalQuickResponses.map((globalQuickResponse) => {
          return  <Button
                    ...
                    className="global-quick-response"
                    onClick={() => this.onGlobalQuickResponseClick(globalQuickResponse)}>{ globalQuickResponse }
                  </Button>;
      }) }
    </div>);
  }
